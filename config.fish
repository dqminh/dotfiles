...
# setting ips for vagrant
export DEV_INTERFACE=33.33.33.10
export BULLDOG_INTERFACE=33.33.33.13

# settings for goboxer
export GOBOXER_INTERFACE=33.33.33.11
export GOBOXER_VM_CPU=1
export GOBOXER_VM_MEM=512

# settings for boxer instance
export BOXER_INTERFACE=33.33.33.12
export BOXER_VM_CPU=1
export BOXER_VM_MEM=512
